-- Actualizar vista de negocios destacados para incluir profile_name
...
COMMENT ON VIEW vista_negocios_destacados IS 'Vista de negocios destacados ordenados por calificación promedio (rating), luego por total de calificaciones, y finalmente por contactos. Incluye profile_name para URLs amigables.';
