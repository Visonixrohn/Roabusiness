...
export default function MobileBottomBar() {
  ...
  // Función para hacer scroll al top al navegar
  ...
  return (
    <nav
      className={`fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-[0_-2px_10px_rgba(0,0,0,0.05)] flex justify-around items-center h-16 md:hidden transition-transform duration-300 ${scrollDirection === "down" ? "translate-y-full" : "translate-y-0"}`}
